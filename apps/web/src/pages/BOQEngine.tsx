...
const BOQEngine = () => {
  ...
  const exportPDF = async () => {
    ...
    const company = user?.company || 'Cpromark';
    ...
    for (let p = 1; p <= pageCount; p++) {
      ...
      doc.setFont('helvetica', 'normal');
      doc.setFontSize(8);
      doc.text('Generated by Cpromark — Construction Operating System', marginX, pageHeight - 26);
        ...
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
           <div className="lg:col-span-2 bg-background p-10 rounded-[3.5rem] text-foreground relative overflow-hidden shadow-2xl">
              ...
              <div className="relative z-10">
                 <h3 className="text-2xl font-bold mb-2">Cpromark AI Estimator</h3>
